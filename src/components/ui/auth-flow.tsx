...
function MiniNavbar({ onSignInClick, onSignUpClick }: { onSignInClick: () => void; onSignUpClick: () => void }) {
...
export const AuthFlow = ({ className, onSuccess }: AuthFlowProps) => {
  const [mode, setMode] = useState<"landing" | "signin" | "signup" | "success">("landing");
  ...
  const { signInWithEmail, signUpWithEmail, verifyOtp, user } = useAuthStore();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === "signin") {
        ...
        await signUpWithEmail(formData.email, formData.password, formData.fullName, formData.username);
        handleSuccess();
      }
    } catch (error: any) {
                ...
                {mode === "landing" ? (
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      <p className="text-[1.8rem] text-white/70 font-light">Choose your path</p>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <button 
                        ...
                        className="w-full backdrop-blur-[2px] flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 text-white border border-white/20 rounded-full py-3 px-4 transition-colors"
                      >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div className="space-y-3">
                        <input 
                          ...
                          className="w-full backdrop-blur-[1px] text-white border border-white/10 rounded-full py-3 px-4 focus:outline-none focus:border-white/30 bg-transparent"
                          required
                          disabled={isLoading}
                        />
                        ...
                        <div className="relative">
                          <input 
                            ...
                            className="w-full backdrop-blur-[1px] text-white border border-white/10 rounded-full py-3 px-4 pr-12 focus:outline-none focus:border-white/30 bg-transparent"
                            required
                            disabled={isLoading}
                          />
                          <button
                      ...
                      <button 
                        type="submit"
                        disabled={isLoading}
                        className="w-full bg-white text-black font-medium py-3 rounded-full hover:bg-white/90 transition-colors disabled:opacity-50"
                      >
